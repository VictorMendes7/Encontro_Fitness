                ...
                <div class="row">
                  <!-- classe Row responsavel por uma linha do formulario -->
                    <div class="col-12 text-center my-7">
                        ...
                        <h1 class="display-4"> <i class="fa fa-clipboard text-primary"></i> Cadastro Cartao</h1>
                 ...
                 <div class="row justify-content-center mb-5">
                     ...
                     <div class="col-sm-12 col-md-10 col-lg-8"> <!-- Definindo os tamanhos da coluna -->
                         ...
                         <form method="post" action="cadastrarCartao2.php">
                         ...
                         <div class="form-row">
                             ...
                             <div class="form-group col-sm-6">
                                     ...
                                     <input type="text" class="form-control" name="nomecartao" placeholder="Nome Cartao" required>
                             ...
                             <div class="form-group col-sm-6">
                                     ...
                                     <input type="number" class="form-control" name="numerocartao" placeholder="Digite o numero do cartao" required>
                             ...
                             <div class="form-group col-sm-6">
                                     ...
                                     <label >Mes:</label>
                                     <input type="number" class="form-control" name="mes" placeholder="Mes" required>
                             ...
                             <div class="form-group col-sm-6">
                                     ...
                                     <label >Ano:</label>
                                     <input type="number" class="form-control" name="ano" placeholder="Ano" required>
                             
                             </div>
                             <div class="form-group col-md-6">
                                 
                                 <label >Código de Segurança:</label>
                                 <input type="number" class="form-control" maxlength="8" name="codseguranca" placeholder="Digite o Código de segurança" required />
