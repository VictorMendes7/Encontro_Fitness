                ...
                <div class="row">
                  <!-- classe Row responsavel por uma linha do formulario -->
                    <div class="col-12 text-center my-6">
                        ...
                        <h1 class="display-4"> <i class="fa fa-clipboard text-primary"></i> Cadastro  Encontro</h1>
                 ...
                 <div class="row justify-content-center mb-5">
                     ...
                     <div class="col-sm-12 col-md-10 col-lg-8"> <!-- Definindo os tamanhos da coluna -->
                         ...
                         <form method="post" action="cadastroEncontro2.php">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="max_pessoas" placeholder="Máximo Pessoas" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" maxlength="8" name="modalidade" placeholder="Modalidade" required />
